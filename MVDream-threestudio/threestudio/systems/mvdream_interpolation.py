...
import threestudio
from threestudio.systems.base import BaseLift3DSystemMultiplePrompts
...
@threestudio.register("mvdream-interpolation-system")
class MVDreamInterpolationSystem(BaseLift3DSystemMultiplePrompts):
    @dataclass
    class Config(BaseLift3DSystemMultiplePrompts.Config):
