...
class BaseLift3DSystemMultiplePrompts(BaseLift3DSystem):
    @dataclass
    class Config(BaseLift3DSystem.Config):
        prompt_processor_type: str = ""
        prompt_processor_A: dict = field(default_factory=dict)
        prompt_processor_B: dict = field(default_factory=dict)
